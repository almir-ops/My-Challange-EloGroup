...
import * as i3 from "./po-gauge-description/po-gauge-description.component";
import * as i4 from "./po-gauge-svg/po-gauge-svg.component";
import * as i5 from "./po-gauge-legend/po-gauge-legend.component";
...
PoGaugeComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PoGaugeComponent, selectors: [["po-gauge"]], viewQuery: function PoGaugeComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [i2.PoGaugeTitleComponent, i3.PoGaugeDescriptionComponent, i4.PoGaugeSvgComponent, i5.PoGaugeLegendComponent], encapsulation: 2 });
