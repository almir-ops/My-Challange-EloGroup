...
import * as i4 from "./directives/po-resize-observer.directive";
...
PoChartComponent.ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: PoChartComponent, selectors: [["po-chart"]], viewQuery: function PoChartComponent_Query(rf, ctx) { if (rf & 1) {
    ...
    } }, directives: [i4.PoResizeObserverDirective, i5.PoChartContainerComponent, i6.NgIf, i6.NgTemplateOutlet, i7.PoChartLegendComponent], encapsulation: 2 });
