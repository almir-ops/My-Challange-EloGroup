 ...
 * </example>
 */
export declare class PoButtonComponent extends PoButtonBaseComponent implements AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoButtonComponent, "po-button", never, {}, {}, never, never>;
}
