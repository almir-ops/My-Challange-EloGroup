...
export declare class PoStepperCircleComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoStepperCircleComponent, "po-stepper-circle", never, { "content": "p-content"; "icons": "p-icons"; "size": "p-size"; "status": "p-status"; }, {}, never, never>;
}
