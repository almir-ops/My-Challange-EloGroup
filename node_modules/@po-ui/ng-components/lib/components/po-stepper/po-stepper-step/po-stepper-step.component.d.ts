...
export declare class PoStepperStepComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoStepperStepComponent, "po-stepper-step", never, { "circleContent": "p-circle-content"; "orientation": "p-orientation"; "nextStatus": "p-next-status"; "label": "p-label"; "status": "p-status"; "stepIcons": "p-step-icons"; "stepSize": "p-step-size"; }, { "activated": "p-activated"; "click": "p-click"; "enter": "p-enter"; }, never, never>;
}
