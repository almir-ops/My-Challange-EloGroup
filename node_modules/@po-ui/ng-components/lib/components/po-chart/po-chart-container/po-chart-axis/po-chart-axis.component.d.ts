...
export declare class PoChartAxisComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoChartAxisComponent, "[po-chart-axis]", never, { "alignByTheCorners": "p-align-by-the-corners"; "type": "p-type"; "range": "p-range"; "series": "p-series"; "categories": "p-categories"; "containerSize": "p-container-size"; "axisOptions": "p-options"; }, { "categoriesCoordinates": "p-categories-coordinates"; }, never, never>;
}
