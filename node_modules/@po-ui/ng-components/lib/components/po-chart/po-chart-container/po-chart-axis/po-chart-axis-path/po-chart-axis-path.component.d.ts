...
export declare class PoChartAxisPathComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoChartAxisPathComponent, "[po-chart-axis-path]", never, { "axisXCoordinates": "p-axis-x-coordinates"; "axisYCoordinates": "p-axis-y-coordinates"; }, {}, never, never>;
}
