...
export declare class PoChartBarPathComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoChartBarPathComponent, "[po-chart-bar-path]", never, { "color": "p-color"; "coordinates": "p-coordinates"; "tooltipPosition": "p-tooltip-position"; }, { "barClick": "p-bar-click"; "barHover": "p-bar-hover"; }, never, never>;
}
