...
export declare class PoSlideCirclesComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoSlideCirclesComponent, "po-slide-circles", never, { "currentSlideIndex": "p-current-slide-index"; "items": "p-items"; }, { "click": "p-click"; }, never, never>;
}
