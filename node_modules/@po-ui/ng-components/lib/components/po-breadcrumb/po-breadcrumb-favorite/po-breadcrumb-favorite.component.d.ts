...
export declare class PoBreadcrumbFavoriteComponent implements OnInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoBreadcrumbFavoriteComponent, "po-breadcrumb-favorite", never, { "favoriteService": "p-favorite-service"; "itemActive": "p-item-active"; "paramsService": "p-params-service"; }, {}, never, never>;
}
