...
export declare class PoDisclaimerBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoDisclaimerBaseComponent, never, never, { "label": "p-label"; "value": "p-value"; "property": "p-property"; "hideClose": "p-hide-close"; "type": "p-type"; }, { "closeAction": "p-close-action"; }, never>;
}
