...
export declare class PoModalBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoModalBaseComponent, never, never, { "title": "p-title"; "primaryAction": "p-primary-action"; "secondaryAction": "p-secondary-action"; "size": "p-size"; "setClickOut": "p-click-out"; "hideClose": "p-hide-close"; }, {}, never>;
}
