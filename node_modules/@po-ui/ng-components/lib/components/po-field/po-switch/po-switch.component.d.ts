...
export declare class PoSwitchComponent extends PoFieldModel<boolean> implements AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoSwitchComponent, "po-switch", never, { "labelPosition": "p-label-position"; "labelOff": "p-label-off"; "labelOn": "p-label-on"; }, {}, never, never>;
}
