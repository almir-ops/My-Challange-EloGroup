...
export declare class PoMultiselectItemComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoMultiselectItemComponent, "po-multiselect-item", never, { "label": "p-label"; "selected": "p-selected"; }, { "change": "p-change"; }, never, never>;
}
