 ...
 * ```
 */
export declare class PoSelectOptionTemplateDirective {
    templateRef: TemplateRef<any>;
    constructor(templateRef: TemplateRef<any>);
    static ɵfac: i0.ɵɵFactoryDeclaration<PoSelectOptionTemplateDirective, never>;
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoSelectOptionTemplateDirective, "[p-select-option-template]", never, {}, {}, never>;
}
