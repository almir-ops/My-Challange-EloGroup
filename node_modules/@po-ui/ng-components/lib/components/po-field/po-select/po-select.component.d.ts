import { AfterViewInit, ChangeDetectorRef, DoCheck, ElementRef, IterableDiffers, Renderer2, EventEmitter } from '@angular/core';
...
export declare class PoSelectComponent extends PoFieldValidateModel<any> implements AfterViewInit, DoCheck {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoSelectComponent, "po-select", never, { "readonly": "p-readonly"; "placeholder": "p-placeholder"; "options": "p-options"; }, { "ngModelChange": "ngModelChange"; }, ["selectOptionTemplate"], never>;
}
