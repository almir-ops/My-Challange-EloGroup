...
export declare abstract class PoCheckboxBaseComponent implements ControlValueAccessor {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoCheckboxBaseComponent, never, never, { "name": "name"; "autoFocus": "p-auto-focus"; "label": "p-label"; "disabled": "p-disabled"; }, { "change": "p-change"; }, never>;
}
