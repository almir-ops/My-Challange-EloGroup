...
export declare class PoRichTextLinkModalComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoRichTextLinkModalComponent, "po-rich-text-link-modal", never, {}, { "command": "p-command"; "linkEditing": "p-link-editing"; }, never, never>;
}
