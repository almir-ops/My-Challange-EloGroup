...
export declare class PoTagBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoTagBaseComponent, never, never, { "label": "p-label"; "value": "p-value"; "color": "p-color"; "icon": "p-icon"; "inverse": "p-inverse"; "orientation": "p-orientation"; "type": "p-type"; }, { "click": "p-click"; }, never>;
}
