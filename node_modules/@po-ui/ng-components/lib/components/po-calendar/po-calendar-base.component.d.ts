...
export declare class PoCalendarBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoCalendarBaseComponent, never, never, { "locale": "p-locale"; "maxDate": "p-max-date"; "minDate": "p-min-date"; "mode": "p-mode"; }, { "change": "p-change"; }, never>;
}
