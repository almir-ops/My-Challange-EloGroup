...
export declare class PoPopoverBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoPopoverBaseComponent, never, never, { "target": "p-target"; "title": "p-title"; "hideArrow": "p-hide-arrow"; "position": "p-position"; "trigger": "p-trigger"; }, { "closePopover": "p-close"; }, never>;
}
