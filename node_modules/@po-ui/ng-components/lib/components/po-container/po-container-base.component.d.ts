...
export declare class PoContainerBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoContainerBaseComponent, never, never, { "height": "p-height"; "noBorder": "p-no-border"; "noPadding": "p-no-padding"; "noShadow": "p-no-shadow"; }, {}, never>;
}
