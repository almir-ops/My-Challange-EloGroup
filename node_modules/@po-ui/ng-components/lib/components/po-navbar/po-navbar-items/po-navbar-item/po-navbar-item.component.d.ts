...
export declare class PoNavbarItemComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoNavbarItemComponent, "po-navbar-item", never, { "action": "p-action"; "clickable": "p-clickable"; "label": "p-label"; "link": "p-link"; }, { "click": "p-click"; }, never, never>;
}
