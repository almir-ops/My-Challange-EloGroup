...
export declare abstract class PoNavbarBaseComponent {
    ...
    static ɵdir: i0.ɵɵDirectiveDeclaration<PoNavbarBaseComponent, never, never, { "iconActions": "p-icon-actions"; "items": "p-items"; "literals": "p-literals"; "logo": "p-logo"; "shadow": "p-shadow"; }, {}, never>;
}
