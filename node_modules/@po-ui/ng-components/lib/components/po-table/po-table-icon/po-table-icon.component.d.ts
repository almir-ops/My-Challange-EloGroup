...
export declare class PoTableIconComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoTableIconComponent, "po-table-icon", never, { "clickable": "p-clickable"; "color": "p-color"; "disabled": "p-disabled"; "icon": "p-icon"; "iconTooltip": "p-icon-tooltip"; }, { "click": "p-click"; }, never, never>;
}
