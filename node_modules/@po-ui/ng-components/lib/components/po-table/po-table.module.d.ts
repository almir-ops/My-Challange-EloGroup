...
import * as i1 from "./po-table.component";
import * as i2 from "./po-table-column-icon/po-table-column-icon.component";
import * as i3 from "./po-table-column-label/po-table-column-label.component";
import * as i4 from "./po-table-column-link/po-table-column-link.component";
import * as i5 from "./po-table-column-manager/po-table-column-manager.component";
import * as i6 from "./po-table-detail/po-table-detail.component";
import * as i7 from "./po-table-icon/po-table-icon.component";
import * as i8 from "./po-table-row-template/po-table-row-template.directive";
import * as i9 from "./po-table-show-subtitle/po-table-show-subtitle.component";
import * as i10 from "./po-table-subtitle-circle/po-table-subtitle-circle.component";
import * as i11 from "./po-table-subtitle-footer/po-table-subtitle-footer.component";
import * as i12 from "./po-table-cell-template/po-table-cell-template.directive";
