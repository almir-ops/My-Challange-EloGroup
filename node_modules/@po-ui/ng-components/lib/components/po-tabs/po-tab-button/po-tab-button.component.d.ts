...
export declare class PoTabButtonComponent implements OnChanges {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoTabButtonComponent, "po-tab-button", never, { "disabled": "p-disabled"; "id": "p-id"; "label": "p-label"; "small": "p-small"; "active": "p-active"; "hide": "p-hide"; }, { "activated": "p-activated"; "changeState": "p-change-state"; "click": "p-click"; }, never, never>;
}
