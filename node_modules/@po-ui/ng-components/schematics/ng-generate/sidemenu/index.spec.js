...
describe('sidemenu:', () => {
    ...
    describe('Imports:', () => {
        it('should add the RouterModule to the project module', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
    ...
    describe('Component: ', () => {
        it('should create app.component.ts|html|css', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
            const tree = yield runner.runSchematicAsync('sidemenu', componentOptions, appTree).toPromise();
        ...
        it('should contains `po-wrapper`, `po-toolbar` and `po-menu` in app.component.html', () => (0, tslib_1.__awaiter)(void 0, void 0, void 0, function* () {
