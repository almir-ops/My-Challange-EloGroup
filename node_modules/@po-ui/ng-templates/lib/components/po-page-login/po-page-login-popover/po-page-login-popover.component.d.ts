...
export declare class PoPageLoginPopoverComponent {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoPageLoginPopoverComponent, "po-page-login-popover", never, { "literals": "p-literals"; "recovery": "p-recovery"; "remainingAttempts": "p-remaining-attempts"; }, { "forgotPassword": "p-forgot-password"; }, never, never>;
}
