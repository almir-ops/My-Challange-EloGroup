...
export declare class PoPageBackgroundComponent implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<PoPageBackgroundComponent, "po-page-background", never, { "background": "p-background"; "initialSelectLanguage": "p-initial-language"; "hideLogo": "p-hide-logo"; "highlightInfo": "p-highlight-info"; "languagesList": "p-languages"; "logo": "p-logo"; "secondaryLogo": "p-secondary-logo"; "showSelectLanguage": "p-show-select-language"; }, { "selectedLanguage": "p-selected-language"; }, never, ["*"]>;
}
